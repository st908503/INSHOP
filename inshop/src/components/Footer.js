...
const Footer = () => {
    return (
        <div>
            <div className='md:grid grid-cols-3 bg-[#F3F6F5] py-16 px-10 md:px-20'>
                ...
                <div className='grid grid-cols-2 '>
                    ...
                    <div className='text-[#07484A] '>
                        ...
                        <div className='pb-6 text-sm flex flex-col'>
                            <Link to='/' className='text-sm pb-2'>Shipping</Link>
                            <Link to='/' className='text-sm pb-2'>Returns</Link>
                            <Link to='/' className='text-sm pb-2'>Sizing</Link>
                        </div>
                    </div>
                </div>
